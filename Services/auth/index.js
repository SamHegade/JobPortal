...
export const register_ad = async (formData) => {
    try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/auth/regadm`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const login_ad = async (formData) => {
    try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/auth/loginadm`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
