        ...
        },
        {
            ...
            cell: row => (
                <div className='flex items-center justify-start w-72 h-20'>
                    ...
                    <button onClick={() => handleAcceptStatus(row?._id)} className=' w-20 py-2 mx-2 text-xs text-green-600 hover:text-white my-2 hover:bg-green-600 border border-green-600 rounded transition-all duration-700'>Accept</button>
