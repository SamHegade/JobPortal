...
export default function JobsCard2({job , posted}) {
    const router = useRouter();
    return (
        <div key={job._id} className='w-full bg-gray-50 cursor-pointer  transition-all duration-1000  md:w-5/12 m-4 border hover:shadow-xl rounded px-4 md:flex md:flex-wrap'>
            <div className='mb-4 flex  items-center justify-center py-2 '>
                <Image width={70} height={70} className="flex rounded-full " src={"/favicon.ico"} alt="no image" />
            ...
            <div className='mb-4 flex   items-start justify-center py-2 flex-col'>
                <div className='flex  px-2 py-2 items-center justify-center '>
                    ...
                    <p className='text-base  font-semibold'>{job?.salary}.RS / month</p>
                </div>
                <div className='flex px-2 py-2 items-center  justify-center'>
                    <BsDot className='text-4xl font-extrabold text-indigo-600' />
                ...
                <div className='flex px-2 py-2 items-center justify-center'>
  <BsDot className='text-4xl font-extrabold text-indigo-600' />
  <h1 className='text-lg text-gray-900'>Job Authority:</h1>
  <p className='text-base font-semibold'>
    {job?.status === 'approved' ? 'Verified' : 'Not Verified'}
  </p>
</div>
            </div>
