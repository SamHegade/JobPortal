...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if(res.success)
    {
      ...
      // localStorage.setItem('usertype', JSON.stringify(res?.finalData?.usertype));
      ...
      //   Router.push('/');
      //     const result = JSON.parse(usertype);
      //   console.log(result);
      // } catch (err) {
      //   // 👇️ This runs
      ...
      // Cookies.set('token', res?.finalData?.token);
      // localStorage.setItem('usertype', JSON.stringify(res?.finalData?.usertype));
      // dispatch(setUserData(localStorage.getItem('usertype') ? JSON.parse(localStorage.getItem('usertype')) : null));
      // Router.push('/');
    }
    else
    {
